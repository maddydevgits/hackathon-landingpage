    ...
    [9343], {
        75740: function(e, t, s) {
            ...
            const n = Object.getPrototypeOf,
                r = new WeakMap,
                a = e => e && (r.has(e) ? r.get(e) : n(e) === Object.prototype || n(e) === Array.prototype),
                i = (e, t = !0) => {
                    r.set(e, t)
                },
                        ...
                        C = {
                            ...
                            set(t, n, r, i) {
                                const u = Reflect.has(t, n),
                                    f = Reflect.get(t, n, i);
                                if (u && (e(f, r) || p.has(r) && e(f, p.get(r)))) return !0;
                                w(n), l(r) && (r = (e => a(e) && e[o] || null)(r) || r);
                                let b = r;
                                if (r instanceof Promise) r.then((e => {
                                    r.status = "fulfilled", r.value = e, m(["resolve", [n], e])
                                })).catch((e => {
                                    r.status = "rejected", r.reason = e, m(["reject", [n], e])
                                }));
                                else {
                                    !c.has(r) && s(r) && (b = h(r));
                                    const e = !d.has(b) && c.get(b);
                                    e && ((e, t) => {
                                        if (v.has(e)) throw new Error("prop listener already exists");
                                        if (g.size) {
                                            const s = t[3](y(e));
                                            v.set(e, [t, s])
                                        } else v.set(e, [t])
                                ...
                                return Reflect.set(t, n, b, i), m(["set", [n], r, f]), !0
                            }
                        },
                        W = t(I, C);
                    p.set(n, W);
                    const O = [I, (e = ++f[1]) => (b === e || g.size || (b = e, v.forEach((([t]) => {
                        const s = t[1](e);
                        s > i && (i = s)
                    }))), i), u, e => {
            ...
            function h(e, t, s) {
                ...
                let i = !1;
                const l = a((e => {
                    r.push(e), s ? t(r.splice(0)) : n || (n = Promise.resolve().then((() => {
                        n = void 0, i && t(r.splice(0))
                    })))
                }));
                return i = !0, () => {
                    i = !1, l()
            ...
            const g = f({
                ...
                W = {
                    ...
                    setConfig(e) {
                        var t, s;
                        v.initialize(), I.setChains(e.chains), I.setIsAuth(Boolean(e.enableAuthMode)), I.setIsCustomMobile(Boolean(null == (t = e.mobileWallets) ? void 0 : t.length)), I.setIsCustomDesktop(Boolean(null == (s = e.desktopWallets) ? void 0 : s.length)), b.setModalVersionInStorage(), Object.assign(C, e)
                    }
                };
            ...
            async function D(e, t) {
                const s = ((e, t) => {
                    ...
                    o = new URL(e, k);
                return o.searchParams.append("projectId", W.state.projectId), Object.entries(s).forEach((([e, t]) => {
            ...
            const P = {
                ...
                getWalletImageUrl: e => `${k}/w3m/v1/getWalletImage/${e}?projectId=${W.state.projectId}&sdkType=wcm&sdkVersion=js-2.6.2`,
                getAssetImageUrl: e => `${k}/w3m/v1/getAssetImage/${e}?projectId=${W.state.projectId}&sdkType=wcm&sdkVersion=js-2.6.2`
            };
            ...
            const _ = b.isMobile(),
                ...
                $ = {
                    ...
                    async getRecomendedWallets() {
                        ...
                        if (b.isArray(e)) {
                            ...
                            const {
                                chains: e,
                                isAuth: s
                            } = I.state, o = e ? .join(","), n = b.isArray(t), r = {
                                page: 1,
                                ...
                                listings: a
                            } = _ ? await P.getMobileListings(r) : await P.getDesktopListings(r);
                            V.recomendedWallets = Object.values(a)
                        }
                    ...
                    async getWallets(e) {
                        ...
                        const {
                            ...
                            listings: i,
                            total: l
                        } = _ ? await P.getMobileListings(t) : await P.getDesktopListings(t), c = Object.values(i), d = a ? "search" : "wallets";
                        return V[d] = {
                ...
                B = {
                    ...
                    open: async e => new Promise((t => {
                        ...
                        if (b.removeWalletConnectDeepLink(), I.setWalletConnectUri(e ? .uri), I.setChains(e ? .chains), m.reset("ConnectWallet"), s && o) z.open = !0, t();
                        else {
                            const e = setInterval((() => {
                                const s = I.state;
            ...
            const G = f({
                ...
                Q = {
                    ...
                    setThemeConfig(e) {
                        ...
                        t && (G.themeMode = t), s && (G.themeVariables = ((e, t) => {
                            for (var s in t || (t = {})) J.call(t, s) && F(e, s, t[s]);
                            if (K)
                                for (var s of K(t)) q.call(t, s) && F(e, s, t[s]);
                            return e
                        })({}, s))
                    }
                },
                ...
                Y = {
                    ...
                    subscribe: e => h(X, (() => e(X))),
                    openToast(e, t) {
                        X.open = !0, X.message = e, X.variant = t
                    },
                    closeToast() {
                        X.open = !1
                    }
