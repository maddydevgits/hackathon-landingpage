        ...
        86284: function(t, e) {
            ...
            var s = function() {
                var t = {
                        ...
                        performAction: function(t, e, s, i, n, r, a) {
                            var o = r.length - 1;
                            switch (n) {
                                case 1:
                                    return r[o - 1];
                                ...
                                case 9:
                                    this.$ = {
                                        ...
                                        value: i.stripComment(r[o]),
                                        strip: i.stripFlags(r[o], r[o]),
                                ...
                                case 18:
                                    ...
                                    break;
                                case 19:
                                    var h = i.prepareBlock(r[o - 2], r[o - 1], r[o], r[o], !1, this._$),
                                        l = i.prepareProgram([h], r[o - 1].loc);
                                    l.chained = !0, this.$ = {
                                        strip: r[o - 2].strip,
                                        program: l,
                                        chain: !0
                        ...
                        parse: function(t) {
                            ...
                            for (var y, _, g, m, f, E, k, b, N, d = {};;) {
                                if (g = s[s.length - 1], this.defaultActions[g] ? m = this.defaultActions[g] : (null !== y && "undefined" != typeof y || (y = u()), m = r[g] && r[g][y]), "undefined" === typeof m || !m.length || !m[0]) {
                                    var S = "";
                                    if (!l) {
                                        for (E in N = [], r[g]) this.terminals_[E] && E > 2 && N.push("'" + this.terminals_[E] + "'");
                                        S = this.lexer.showPosition ? "Parse error on line " + (o + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + N.join(", ") + ", got '" + (this.terminals_[y] || y) + "'" : "Parse error on line " + (o + 1) + ": Unexpected " + (1 == y ? "end of input" : "'" + (this.terminals_[y] || y) + "'"), this.parseError(S, {
                                ...
                                if (m[0] instanceof Array && m.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + g + ", token: " + y);
                                switch (m[0]) {
                                    case 1:
                                        s.push(y), i.push(this.lexer.yytext), n.push(this.lexer.yylloc), s.push(m[1]), y = null, _ ? (y = _, _ = null) : (h = this.lexer.yyleng, a = this.lexer.yytext, o = this.lexer.yylineno, c = this.lexer.yylloc, l > 0 && l--);
                                        break;
                                    case 2:
                                        if (k = this.productions_[m[1]][1], d.$ = i[i.length - k], d._$ = {
                                                first_line: n[n.length - (k || 1)].first_line,
                                                last_line: n[n.length - 1].last_line,
                                                first_column: n[n.length - (k || 1)].first_column,
                                                last_column: n[n.length - 1].last_column
                                            }, p && (d._$.range = [n[n.length - (k || 1)].range[0], n[n.length - 1].range[1]]), "undefined" !== typeof(f = this.performAction.call(d, a, h, o, this.yy, m[1], i, n))) return f;
                                        k && (s = s.slice(0, -1 * k * 2), i = i.slice(0, -1 * k), n = n.slice(0, -1 * k)), s.push(this.productions_[m[1]][0]), i.push(d.$), n.push(d._$), b = r[s[s.length - 2]][s[s.length - 1]], s.push(b);
                                        break;
                                    case 3:
                                        return !0
                                }
                    ...
                    e = function() {
                        var t = {
                            ...
                            next: function() {
                                ...
                                for (var r = this._currentRules(), a = 0; a < r.length && (!(s = this._input.match(this.rules[r[a]])) || e && !(s[0].length > e[0].length) || (e = s, i = a, this.options.flex)); a++);
